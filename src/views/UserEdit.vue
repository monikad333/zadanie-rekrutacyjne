  ...
  <div class="view">
    ...
    <div class="row">
      <DefaultCard left-content="Logs" right-content="Permissions" class="card">
        ...
        <template #bottom><div class="table-section bg-white border-t border-gray-300">
          <div class="relative overflow-x-auto px-2">
            <table class="w-full text-sm text-left text-gray-500 text-gray-400">
              <thead class="text-xs border-b text-gray-700 bg-gray-50 bg-white-700 border-gray-700">
                <tr>
